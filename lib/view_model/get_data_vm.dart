...
import 'package:flutter_with_graphql/data/schema/get_data_schema.dart';
import 'package:flutter_with_graphql/data/url_endpoint.dart';
...
class GetDataProvider extends ChangeNotifier {
  ...
  void getData(bool isLocal) async {
